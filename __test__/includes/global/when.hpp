...
namespace ContainerAssured
{
	...
	public:
		When(const char* mn) : methodname(mn) {}
	...
	public:
		...
		TesterResult<Cont, Result, voidParameterPack> impl(Cont& c, Result (Cont::*pm)())
		{
			...
			return (TesterResult<Cont, Result, voidParameterPack>(c, result, voidParameterPack(), this->endTime - this->startTime, methodname));
		}
		template <class Cont>
		...
		impl(Cont& c, Result (Cont::*pm)(Arg), Arg arg)
		{
			...
			this->endTime = std::chrono::steady_clock::now();
			return (TesterResult<Cont, Result, typename OneParameterPack<Arg>::type>(c, result, typename OneParameterPack<Arg>::type(arg), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg>
		TesterResult<Cont,
					 Result, typename OneParameterPack<Arg>::type>
		impl(Cont& c, Result (Cont::*pm)(Arg) const, Arg arg)
		{
			...
			return (TesterResult<Cont, Result,
								 typename OneParameterPack<Arg>::type>(c,
																	   ...
																	   this->endTime - this->startTime, methodname));
		}
		/**
		...
		TesterResult<Cont, Result, typename TwoParameterPack<Arg1, Arg2>::type> impl(Cont& c, Result (Cont::*pm)(Arg1, Arg2), Arg1 arg1, Arg2 arg2)
		{
			...
			this->endTime = std::chrono::steady_clock::now();
			return (TesterResult<Cont, Result, typename TwoParameterPack<Arg1, Arg2>::type>(c, result, typename TwoParameterPack<Arg1, Arg2>::type(arg1, arg2), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg1, class Arg2>
		...
		TesterResult<Cont, Result, typename ThreeParameterPack<Arg1, Arg2, Arg3>::type> impl(Cont& c, Result (Cont::*pm)(Arg1, Arg2, Arg3), Arg1 arg1, Arg2 arg2, Arg3 arg3)
		{
			...
			this->endTime = std::chrono::steady_clock::now();
			return (TesterResult<Cont, Result, typename ThreeParameterPack<Arg1, Arg2, Arg3>::type>(c, result, typename ThreeParameterPack<Arg1, Arg2, Arg3>::type(arg1, arg2, arg3), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg1, class Arg2, class Arg3>
		...
		TesterResult<Cont, Result, ParameterPack<Arg1, Arg2, Arg3, Arg4> > impl(Cont& c, Result (Cont::*pm)(Arg1, Arg2, Arg3, Arg4), Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
		{
			...
			this->endTime = std::chrono::steady_clock::now();
			return (TesterResult<Cont, Result, ParameterPack<Arg1, Arg2, Arg3, Arg4> >(c, result, ParameterPack<Arg1, Arg2, Arg3, Arg3>(arg1, arg2, arg3, arg4), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg1, class Arg2, class Arg3, class Arg4>
	...
	public:
		...
		TesterResult<Cont, void, voidParameterPack> impl(Cont& c, void (Cont::*pm)())
		{
			...
			return (TesterResult<Cont,
								 void,
								 voidParameterPack>(c, voidParameterPack(), this->endTime - this->startTime, methodname));
		}
		template <class Cont>
		...
		TesterResult<Cont, void, typename TwoParameterPack<Arg1, Arg2>::type> impl(Cont& c, void (Cont::*pm)(Arg1, Arg2), Arg1 arg1, Arg2 arg2)
		{
			...
			return TesterResult<Cont,
								void,
								typename TwoParameterPack<Arg1, Arg2>::type>(c, typename TwoParameterPack<Arg1, Arg2>::type(arg1, arg2), this->endTime - this->startTime, methodname);
		}
		template <class Cont, class Arg1, class Arg2>
		...
		TesterResult<Cont, void, typename ThreeParameterPack<Arg1, Arg2, Arg3>::type> impl(Cont& c, void (Cont::*pm)(Arg1, Arg2, Arg3), Arg1 arg1, Arg2 arg2, Arg3 arg3)
		{
			...
			return (TesterResult<Cont,
								 void,
								 typename ThreeParameterPack<Arg1, Arg2, Arg3>::type>(c, typename ThreeParameterPack<Arg1, Arg2, Arg3>::type(arg1, arg2, arg3), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg1, class Arg2, class Arg3>
		...
		TesterResult<Cont, void, ParameterPack<Arg1, Arg2, Arg3, Arg4> > impl(Cont& c, void (Cont::*pm)(Arg1, Arg2, Arg3, Arg4), Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
		{
			...
			return (TesterResult<Cont,
								 void,
								 ParameterPack<Arg1, Arg2, Arg3, Arg4> >(c, ParameterPack<Arg1, Arg2, Arg3, Arg4>(arg1, arg2, arg3, arg4), this->endTime - this->startTime, methodname));
		}
		template <class Cont, class Arg1, class Arg2, class Arg3, class Arg4>
