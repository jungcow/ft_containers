...
public:
	template <class Cont>
	VectorUtil::FrontGiven<Cont> given(Cont& c)
	{
		return VectorUtil::FrontGiven<Cont>(c);
	}
};
...
public:
	template <class Cont>
	VectorUtil::FrontConstGiven<Cont> given(Cont& c)
	{
		return VectorUtil::FrontConstGiven<Cont>(c);
	}
};
