...
public:
	template <class Cont>
	VectorUtil::OperatorIndexGiven<Cont> given(Cont& c)
	{
		return VectorUtil::OperatorIndexGiven<Cont>(c);
	}
};
...
public:
	template <class Cont>
	VectorUtil::OperatorIndexConstGiven<Cont> given(Cont& c)
	{
		return VectorUtil::OperatorIndexConstGiven<Cont>(c);
	}
};
